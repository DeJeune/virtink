...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineReplicaSetCondition) DeepCopyInto(out *VirtualMachineReplicaSetCondition) {
	*out = *in
...
func (in *VirtualMachineReplicaSetCondition) DeepCopy() *VirtualMachineReplicaSetCondition {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineReplicaSetCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMachineReplicaSetStatus) DeepCopyInto(out *VirtualMachineReplicaSetStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]VirtualMachineReplicaSetCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
